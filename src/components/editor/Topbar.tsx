...
import {
  ...
  ChevronDown, Zap, Grid3x3, SquareDashedBottom,
} from 'lucide-react';
...
export default function Topbar() {
  ...
  return (
    <div className="h-[52px] border-b border-white/5 glass flex items-center px-4 gap-3 shrink-0 z-30">
      ...
      <div className="flex items-center gap-0.5">
        <button
          ...
          className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${
            showGrid ? 'text-blue-400 bg-blue-500/15' : 'text-white/40 hover:text-white hover:bg-white/8'
          }`}
        >
        ...
        <button
          ...
          title="Contours"
          className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all ${
            showOutlines ? 'text-blue-400 bg-blue-500/15' : 'text-white/40 hover:text-white hover:bg-white/8'
          }`}
        >
      ...
      {/* Preview */}
      <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg glass-hover text-white/60 hover:text-white text-sm transition-all">
